...
<div class="row">
    <div class="col-xl-12">
        <div class="card">
            ...
            <div class="card-body">
                <form id="formAuthentication" method="POST" action="{{ route('subcategories.store') }}" enctype="multipart/form-data">
                    @csrf

                    <div class="mb-4">
                        <label class="form-label" for="name">Subcategory Name</label>
                        <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="Subcategory Name" required>
                        @error('name')
